  ...
  return (
    <section className="content-grid">
      <div className="content-grid__header">
        <h2 className="content-grid__title">News & Events</h2>
        <p className="content-grid__subtitle">
          전북 바이오 산업의 최신 소식과 동향을 한눈에 확인하세요.
        </p>
      </div>
      {showTabs && (
        <div className="content-grid__tabs">
      ...
      {!isLoading && !isError && filteredData.length > 0 && (
        <>
          ...
          {showLoadMore && (
            <div className="content-grid__load-more">
      ...
      {!isLoading && !isError && filteredData.length === 0 && (
        <div className="content-grid__empty-state">
          <p>표시할 콘텐츠가 없습니다.</p>
        </div>
      )}
    </section>
